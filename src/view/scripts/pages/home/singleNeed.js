...
const SingleNeed = (probs)=> {
    ...
    const renderDonateDialog=()=>{
      if(openDialog === true)
      {
        return <Donate donatemount={decRemained} close={closeDialog} id={probs.NeedReqid} remained={probs.moneytarget - probs.donatedmoney} />
      }
    }
    ...
    return(
      ...
      <div id={probs.NeedReqid} key={probs.NeedReqid} style={{paddingBottom:16}}>
        ...
        <Accordion >
          ...
          <AccordionSummary
            ...
            <div style={{flexBasis: '33.33%',marginRight: '30px'}} >
              <Typography style={{fontSize:15, display:onCacellModify}} >{probs.description}</Typography>
              <div style={{display: inModify, width:'100%'}}></div>
            </div>

            <div style={{flexBasis: '33.33%',marginRight: '30px'}} >
              <Typography style={{fontSize:15, display:onCacellModify}} >${probs.moneyNeed,-donatedmoney}</Typography>
              <div style={{display: inModify, width:'100%'}}></div>
            </div>

            <div style={{flexBasis: '33.33%'}} >
              <Typography style={{fontSize:15, color:"#000000" ,opacity: 0.5}} >#{probs.NeedReqid}</Typography>
            </div>
            <div style={{flexBasis: '33.33%'}} >
